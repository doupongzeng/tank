...
Music::Music()
{
	mciSendString(TEXT("open resource\\music\\add.wav alias add"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\start.wav alias start"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\switch.wav alias switch"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\hit_wall.wav alias hit_wall"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\hit_tank.wav alias hit_tank"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\lose.wav alias lose"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\dead_enemy.wav alias dead_enemy"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\dead_player.wav alias dead_player"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\prop_appear.wav alias prop_appear"), NULL, 0, NULL);
	mciSendString(TEXT("open resource\\music\\prop_get.wav alias prop_get"), NULL, 0, NULL);
}
Music::~Music()
{
